...
// Keyword -> event signal map. A product can match multiple events.
const EVENT_SIGNALS = {
...
// Category-level fallback: when a product has zero explicit keyword matches,
// infer plausible events from which product category it belongs to. This keeps
// thin event hubs (bachelorette, surprise, anniversary, nye) populated using
// categories that are thematically relevant even without literal title matches.
const CATEGORY_EVENT_FALLBACK = {
  'drinking-games': ['bachelor','bachelorette'],
  'bar-gadgets': ['bachelor','anniversary'],
  'photo-booth': ['bachelorette','birthday'],
  'party-wearables': ['bachelorette','nye'],
  'festival-gear': ['bachelorette'],
  'drinkware': ['anniversary','romance'],
  'smart-lighting': ['nye','romance','surprise'],
  'theme-decor': ['surprise','birthday'],
  'interactive-games': ['surprise'],
  'party-favors': ['surprise','birthday'],
  'ice-chill': ['anniversary'],
  'tableware': ['nye'],
}
