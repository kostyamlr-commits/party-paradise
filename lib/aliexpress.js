...
// Ordered array (not object) so numeric index is meaningful for batching:
// CATEGORY_LIST[0] is always neon-signs, CATEGORY_LIST[39] is always emergency-kit.
export const CATEGORY_LIST = [
  { id: 'neon-signs',        keywords: ['custom wall neon art'] },
  { id: 'disco-balls',       keywords: ['mirrored disco party ball'] },
  { id: 'led-strips',        keywords: ['music sync rgb strip light'] },
  { id: 'laser-projectors',  keywords: ['dj stage laser projector'] },
  { id: 'fog-machines',      keywords: ['portable party fog machine'] },
  { id: 'bubble-machines',   keywords: ['automatic bubble blower machine'] },
  { id: 'starry-projectors', keywords: ['galaxy night light projector'] },
  { id: 'glow-decor',        keywords: ['neon fluorescent party paint'] },
  { id: 'sensory-lighting',  keywords: ['sound reactive ambient light'] },
  { id: 'smoke-fluids',      keywords: ['fog machine special effect liquid'] },

  { id: 'beer-pong',         keywords: ['inflatable beer pong set','beer pong table set'] },
  { id: 'shot-roulette',     keywords: ['drinking game roulette wheel'] },
  { id: 'electric-openers',  keywords: ['automatic rechargeable bottle opener'] },
  { id: 'dispensers',        keywords: ['liquor gravity dispenser'] },
  { id: 'ice-molds',         keywords: ['skull ice mold tray'] },
  { id: 'led-ice',           keywords: ['waterproof led ice cube'] },
  { id: 'custom-straws',     keywords: ['reusable party straw kit'] },
  { id: 'bar-gadgets',       keywords: ['professional bar shaker set'] },
  { id: 'flasks',            keywords: ['hidden stainless steel flask'] },
  { id: 'drink-markers',     keywords: ['colorful glass drink marker'] },

  { id: 'card-games',        keywords: ['hilarious party card game'] },
  { id: 'tabletop-games',    keywords: ['board game for adult party'] },
  { id: 'interactive',       keywords: ['group interactive party gadget','party icebreaker gadget'] },
  { id: 'voice-changers',    keywords: ['handheld megaphone voice changer'] },
  { id: 'karaoke',           keywords: ['portable bluetooth karaoke mic'] },
  { id: 'prank-items',       keywords: ['fun harmless prank kit','funny prank toy gift'] },
  { id: 'riddles',           keywords: ['party trivia card game'] },
  { id: 'arcade',            keywords: ['mini tabletop arcade game'] },
  { id: 'spin-the-wheel',    keywords: ['prize spin wheel for events'] },
  { id: 'challenges',        keywords: ['party challenge box'] },

  { id: 'photo-props',       keywords: ['trendy photo booth accessory'] },
  { id: 'led-costumes',      keywords: ['glowing led party mask'] },
  { id: 'headwear',          keywords: ['light up party hat'] },
  { id: 'festival-fanny',    keywords: ['transparent festival waist bag'] },
  { id: 'confetti',          keywords: ['party confetti air launcher'] },
  { id: 'party-favors',      keywords: ['creative small party favor'] },
  { id: 'tableware',         keywords: ['luxury metallic disposable plate','gold rim party plate'] },
  { id: 'cake-toppers',      keywords: ['custom led cake topper','birthday cake topper decoration'] },
  { id: 'outdoor-lights',    keywords: ['waterproof solar string light'] },
  { id: 'emergency-kit',     keywords: ['party survival quick kit','hangover recovery kit'] },
]

// Backward-compatible object form, derived from CATEGORY_LIST, for any code
// that still keys off CATEGORIES[cat] (CAT_GROUPS, CAT_LABELS lookups, etc).
...
export function filterProducts(rawProducts, existingTitles = []) {
  ...
  // Sort by sales volume (highest first) BEFORE filtering/dedup, so the
  // hottest-selling products win the MAX_PER_QUERY cap - per Kostya/Gemini spec.
