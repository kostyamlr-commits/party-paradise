...
const EVENT_GUIDES = {
  christmas: {
    ...
    relatedCats: ['neon-signs','led-strips','cake-toppers','tableware','drink-markers'],
  },
  halloween: {
    ...
    relatedCats: ['fog-machines','led-costumes','prank-items','glow-decor'],
  },
  bachelorette: {
    ...
    relatedCats: ['photo-props','beer-pong','headwear','flasks','festival-fanny'],
  },
  bachelor: {
    ...
    relatedCats: ['bar-gadgets','shot-roulette','karaoke','ice-molds'],
  },
  nye: {
    ...
    relatedCats: ['sensory-lighting','tableware','party-favors','outdoor-lights','disco-balls'],
  },
  birthday: {
    ...
    relatedCats: ['cake-toppers','interactive','confetti','tableware'],
  },
  kids: {
    ...
    relatedCats: ['tabletop-games','party-favors','headwear'],
  },
  romance: {
    ...
    relatedCats: ['sensory-lighting','drink-markers','led-ice','flasks'],
  },
  anniversary: {
    ...
    relatedCats: ['drink-markers','cake-toppers','led-ice','dispensers'],
  },
  surprise: {
    ...
    relatedCats: ['confetti','sensory-lighting','interactive','party-favors'],
  },
}
